		...
		<div class="col-10 right bg-faded py-2 pr-5">
			...
			<form action="update" method="post">
				<div class="form-group">
					<label for="displayId">Class ID</label> 
					<input type="text"
						class="form-control" id="displayId" placeholder="Enter Class ID"
						value="${classroom.class_id}" disabled>
					<input type="hidden" name="classId" value="${classroom.class_id}">
				</div>

				<div class="form-group">
					<label for="className">Class Name</label> <input type="text"
						class="form-control" id="className" placeholder="Enter Class Name"
						name="className" value="${classroom.class_name}">
				</div>
